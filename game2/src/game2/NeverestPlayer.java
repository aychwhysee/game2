...
public class NeverestPlayer {
    ...
    public NeverestPlayer(Posn posn, int b_width, int b_height,
    ...
    public NeverestPlayer move(String kee) {
        if (kee.equals("left")) {
            return new NeverestPlayer(new Posn(this.posn.x - movementSpeed, this.posn.y),
            ...
            return new NeverestPlayer(new Posn(this.posn.x, this.posn.y - movementSpeed),
            this.b_width, this.b_height, this.movementSpeed, this.attackStat,
            this.money);
    ...
    public NeverestPlayer levelUp() {
        Random rand = new Random();
        int min = 1;
        int max = 3;
        int randUp = rand.nextInt((max - min) + 1) + min;
        return new NeverestPlayer(this.posn, this.b_width, this.b_height,
